...
//     }
   ...
   const {data, isLoading} = useQuery(`categoryDetails${_id}`,getCategoryDetails)

    async function getCategoryDetails(){
        return await axios.get(`https://ecommerce.routemisr.com/api/v1/categories/${_id}`)
    }
    ...
    <div className="md:w-[80%]  mx-auto">
      <div className="flex flex-wrap justify-center items-center">
        <div className="md:w-1/3 p-5">
         ...
         <div>
           <h1 className="text-3xl font-bold mb-3">{data?.data.data.name}</h1>
